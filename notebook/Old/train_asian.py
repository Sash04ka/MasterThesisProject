...
df = pd.read_csv(os.path.join(project_root, "data", "option_dataset_asian.csv"))
...
X_test.to_csv(os.path.join(project_root, "data", "X_test_asian.csv"), index=False)
y_test.to_csv(os.path.join(project_root, "data", "y_test_asian.csv"), index=False)
print("✅ Test data saved")

print("👋 Finished train_asian.py")
